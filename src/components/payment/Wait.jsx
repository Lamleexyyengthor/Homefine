          ...
          <table className="w-full border-collapse-separate border-spacing-0 h-[53px] rounded-2xl mt-2 mr-2 ml-2 overflow-hidden border border-gray-300 bg-white">
            <thead>
              <tr className="bg-[#00B8D1] text-white text-lg">
                ...
                <th className="px-4 py-2">ຄ່າເຊົ່າ</th>
                ...
                <th className="px-4 py-2">ລາຍລະອຽດ</th>
              </tr>
            </thead>
            <tbody>
              {data.map((row, index) => (
                <tr key={index} className=" mt-3">
                  ...
                  <td className="px-8 py-6 text-center">{row.rent}</td>
                  ...
                  <td className="px-8 py-6 flex justify-center">
                    {row.status === "ຍັງບໍ່ຊໍາລະ" ? (
                      <span className="flex items-center justify-center w-[81px] h-[40px] font-bold border-2 bg-green-100 text-green-700 rounded-full">
                        {row.status}
                      </span>
                    ) : (
                      <span className="flex items-center justify-center w-[81px] h-[40px] font-bold border-2 bg-red-100 text-red-600 rounded-full">
                        {row.status}
                      </span>
                    )}
                  </td>
