              ...
              {data.map((row, index) => (
                <tr key={index} className=" mt-3">
                  ...
                  <td className="px-8 py-6 flex justify-center">
                    {row.status === "ຊໍາລະແລ້ວ" ? (
                      <span className="flex items-center justify-center font-bold w-[81px] h-[40px] border-2 bg-green-100 text-green-700 rounded-full">
                        {row.status}
                      </span>
                    ) : (
                      <span className="flex items-center justify-center w-[81px] h-[40px] bg-red-100 text-red-600 rounded-full">
                        {row.status}
                      </span>
                    )}
                  </td>
