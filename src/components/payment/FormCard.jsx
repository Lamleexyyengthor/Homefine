      ...
      {pay.map((data) => (
        <div className="shadow-2xl mx-auto my-auto w-[390px] flex flex flex-col h-[557px]">
              ...
              <div className="w-full h-full justify-center rounded-md bg-white shadow-md">
                ...
                <div className="flex flex-row justify-between">
                  ...
                  <div className="flex flex-col gap-2  mr-10 mt-5">
                    <p className="text-[13px] text-[#6B7280]">{data.rent} ກີບ</p>
          ...
          <div className="flex mt-7 flex-row justify-between">
            <div className="flex">
              <button className="w-[98px] ml-8  border-[#FF0000] bg-[#FECACA] border-2 rounded-full h-[34px]">
                <p className="text-[#FF0000] text-center font-bold text-[15px]">
                  ຍັງບໍ່ຊໍາລະ
                </p>
              </button>
            </div>
            <div className="flex">
              <button className="w-[98px] mr-8 font-bold text-[15px] text-white bg-[#00B8D1] rounded-full h-[34px]">
                <p>ອະນຸມັດ</p>
              </button>
            </div>
          </div>
