...
export const Manage = () => {
  ...
  const [activeTab, setActiveTab] = useState("/bookings"); // ค่า default
  const handleSave = () => {
  ...
  const tabs = [
    { label: "ລາຍການຈອງ", path: "/bookings" },
    { label: "ປະຫວັດການຈອງ", path: "/bookings/history" },
  ];
  const handleAddss = () => {
    ...
    <div className=" p-4 bg-gray-50 min-h-screen scrollbar-hide overflow-hidden">
      ...
      <div className=" flex flex-row items-center gap-4">
        <div className="relative w-[400px] mb-4">
          <input
            type="text"
            placeholder="ຄົ້ນຫາເລກຫ້ອງ, ລາຄາ, ສະຖານ"
