      ...
      {data.map((data) => (
        <div className="flex flex-col w-[408px] shadow-2xl h-[550px]">
          <div className="flex flex-row items-center justify-between">
            ...
            <div className="flex border-2 mt-10 mr-5 text-[#009436] items-center justify-center font-bold rounded-full bg-[#DCFCE7] border-[#009436] w-[102px] h-[35px]">
              <p>ວ່າງ</p>
            </div>
          </div>
