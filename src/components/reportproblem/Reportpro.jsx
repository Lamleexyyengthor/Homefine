...
export const Reportpro = () => {
  ...
  const [activeTab, setActiveTab] = useState("/reportproblem"); // ค่า default
  const handleSave = () => {
  ...
  const tabs = [
    { label: "ຫ້ອງທັງໝົດ", path: "/reportproblem" },
    { label: "ລໍຖ້າສ້ອມແປງ", path: "/reportproblem/waitreport" },
    { label: "ກໍາລັງສ້ອມແປງ", path: "/reportproblem/beingreport" },
    { label: "ສ້ອມແປງສໍາເລັດ", path: "/reportproblem/successreport" },
  ];
  const handleAddss = () => {
